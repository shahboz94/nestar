...
import { MemberService } from '../member/member.service'; // <-- shu import kerak
...
export class BoardArticleService {
	constructor(
		...
		private readonly memberService: MemberService, // <-- shu joyda inject qilinadi
		private readonly viewService: ViewService, // <-- shu joyda inject qilinadi
	) {}
